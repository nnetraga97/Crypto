...
import com.nnetraga.crypto.settlement.web.dto.CreateSettlementIntentRequest;
...
public class SettlementController {
    ...
    public SettlementIntent create(@Valid @RequestBody CreateSettlementIntentRequest request) {
